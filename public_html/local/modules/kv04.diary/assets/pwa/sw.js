 ...
 */
// v2 — разовая чистка. Файлы конвертера PDF какое-то время уезжали без
// метки ?v=, и у тех, кто успел его открыть, они осели в кэше навсегда:
// правила ниже спрашивают сервер только при промахе. Смена имени кэша
// выбрасывает старые записи в activate — другого способа их достать нет.
const CACHE = 'kv04-diary-v2';
